...
def main_page(root, name_var, passw_var,tk):
    ...
    def add():
        ...
        UserNewCredentials = StoredCredential(passw_var.get(), name_var.get(),website_var.get())
        # encryption
    ...
    website_entry = tk.Entry(root, textvariable=website_var, font=("calibre", 10, "normal"))
